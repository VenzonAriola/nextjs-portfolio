  ...
  return (
    <Link href={href} className={`${className} relative group`}>
      ...
      <span
        ...
        -bottom-0.5 group-hover:w-fulll transition-[width] ease duration-300} ${
    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="https://github.com/MightyBeast89"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mr-3"
          ...
          <motion.a
            href="https://www.linkedin.com/in/venzonariola/"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
          ...
          <motion.a
            href="https://www.facebook.com/ariolavince"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 ml-3 bg-light rounded-md "
          >
            <FacebookIcon />
          </motion.a>
          <button
      ...
      fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32"
        >
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 mr-3 sm:mx-1 rounded-full bg-light dark:bg-dark"
            >
              <GithubIcon />
            </motion.a>
            <motion.a
